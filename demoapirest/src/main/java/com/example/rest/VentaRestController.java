...
public class VentaRestController {
	...
	public ResponseEntity<Venta> updateVenta(@PathVariable("id") int id, @RequestBody Venta venta) {
		...
		currentVenta.setNombrelibro(venta.getNombrelibro());
		currentVenta.setTipolibro(venta.getTipolibro());
	...
	public ResponseEntity<Iterable<Venta>> getVentaTipoLibro(@PathVariable("tipolibro") String tipolibro) {

		Iterable<Venta> ventas = ventaService.findByTipolibroOrderByMontopagoAsc(tipolibro);
